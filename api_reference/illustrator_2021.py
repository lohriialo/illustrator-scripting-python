...
CLSID = IID('{32307797-1F1D-4501-8F73-163F0AB321E0}')
MajorVersion = 1
MinorVersion = 0
LibraryFlags = 8
LCID = 0x0
...
class GridRepeatItems(DispatchBaseClass):
	...
	def Add(self, SourceArt=defaultNamedNotOptArg, Config=defaultNamedNotOptArg):
		...
		ret = self._oleobj_.InvokeTypes(1665614666, LCID, 1, (9, 0), ((12, 1), (9, 1)),SourceArt
			, Config)
		if ret is not None:
			ret = Dispatch(ret, u'Add', '{5AFEEA77-5B36-478B-8644-0046EED66F0B}')
		return ret
	...
	def Item(self, ItemKey=defaultNamedNotOptArg):
		...
		if ret is not None:
			ret = Dispatch(ret, u'Item', '{5AFEEA77-5B36-478B-8644-0046EED66F0B}')
		return ret
...
class RadialRepeatItems(DispatchBaseClass):
	...
	def Add(self, SourceArt=defaultNamedNotOptArg, Config=defaultNamedNotOptArg):
		...
		ret = self._oleobj_.InvokeTypes(1666335562, LCID, 1, (9, 0), ((12, 1), (9, 1)),SourceArt
			, Config)
		if ret is not None:
			ret = Dispatch(ret, u'Add', '{0DFA722D-2B42-4B0E-82F3-EB2A5C06B19C}')
		return ret
	...
	def Item(self, ItemKey=defaultNamedNotOptArg):
		...
		if ret is not None:
			ret = Dispatch(ret, u'Item', '{0DFA722D-2B42-4B0E-82F3-EB2A5C06B19C}')
		return ret
...
class SymmetryRepeatItems(DispatchBaseClass):
	...
	def Add(self, SourceArt=defaultNamedNotOptArg, Config=defaultNamedNotOptArg):
		...
		ret = self._oleobj_.InvokeTypes(1666401098, LCID, 1, (9, 0), ((12, 1), (9, 1)),SourceArt
			, Config)
		if ret is not None:
			ret = Dispatch(ret, u'Add', '{E2AFAB7C-0C6A-44AC-83E2-BDB22D513DFF}')
		return ret
	...
	def Item(self, ItemKey=defaultNamedNotOptArg):
		...
		if ret is not None:
			ret = Dispatch(ret, u'Item', '{E2AFAB7C-0C6A-44AC-83E2-BDB22D513DFF}')
		return ret
...
class _Application(DispatchBaseClass):
	...
	coclass_clsid = IID('{7CACE1D4-C629-4A43-8E45-800FB2B00015}')
	...
	def OpenCloudDocument(self, CloudPath=defaultNamedNotOptArg):
		...
		if ret is not None:
			ret = Dispatch(ret, u'OpenCloudDocument', '{95CD20AB-AD72-11D3-B086-0010A4F5C335}')
		return ret
...
class _CMYKColor(DispatchBaseClass):
	...
	coclass_clsid = IID('{B3ED0A49-88C1-4404-904B-707BA58F4DB8}')
...
class _Dimensions(DispatchBaseClass):
	...
	coclass_clsid = IID('{BAED5626-5928-432A-BDB1-8712C1FFD1AA}')
...
class _DocumentPreset(DispatchBaseClass):
	...
	coclass_clsid = IID('{48F2D380-582A-44FF-BDA3-1F5C10749F1A}')
...
class _EPSSaveOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{A58534E1-AE76-4F4E-89F6-D7FF62505CED}')
...
class _ExportForScreensItemToExport(DispatchBaseClass):
	...
	coclass_clsid = IID('{4598B50D-CF01-4F98-9221-B85BA0AE7887}')
...
class _ExportForScreensOptionsJPEG(DispatchBaseClass):
	...
	coclass_clsid = IID('{61961433-502B-4D9B-B01F-4F9104743D61}')
...
class _ExportForScreensOptionsPNG24(DispatchBaseClass):
	...
	coclass_clsid = IID('{7FE48456-9E59-4A68-A574-22C94B55B63D}')
...
class _ExportForScreensOptionsPNG8(DispatchBaseClass):
	...
	coclass_clsid = IID('{5E018E7D-FFB0-419B-921C-8C3C7B1D2266}')
...
class _ExportForScreensOptionsWebOptimizedSVG(DispatchBaseClass):
	...
	coclass_clsid = IID('{B6381ED3-F3A1-4172-8E92-37C4B89B3A91}')
...
class _ExportForScreensPDFOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{6B43D877-331F-417D-BED7-4DFC63BC8731}')
...
class _ExportOptionsAutoCAD(DispatchBaseClass):
	...
	coclass_clsid = IID('{6E8DB625-6B40-4F7F-BD15-CD11A533FEB9}')
...
class _ExportOptionsFlash(DispatchBaseClass):
	...
	coclass_clsid = IID('{B93B4F70-262D-4E9E-BD7B-EF181865B55A}')
...
class _ExportOptionsGIF(DispatchBaseClass):
	...
	coclass_clsid = IID('{E831E5A3-6F71-461A-95C1-50812357F50C}')
...
class _ExportOptionsJPEG(DispatchBaseClass):
	...
	coclass_clsid = IID('{7D014CE6-4934-4A50-914A-7729247C44DF}')
...
class _ExportOptionsPNG24(DispatchBaseClass):
	...
	coclass_clsid = IID('{7BB47D53-1D11-49D1-9D16-0A13715404ED}')
...
class _ExportOptionsPNG8(DispatchBaseClass):
	...
	coclass_clsid = IID('{3F0A136F-C0DA-4DC5-8AFA-A0A89F72817F}')
...
class _ExportOptionsPhotoshop(DispatchBaseClass):
	...
	coclass_clsid = IID('{1F6ACC71-4D6C-4DDC-9318-E25D086DF7C1}')
...
class _ExportOptionsSVG(DispatchBaseClass):
	...
	coclass_clsid = IID('{DE11E0DD-668F-4888-8953-B6D7E37C022F}')
...
class _ExportOptionsTIFF(DispatchBaseClass):
	...
	coclass_clsid = IID('{7710CBD8-E89B-429D-8F5C-E2A9B5872311}')
...
class _ExportOptionsWebOptimizedSVG(DispatchBaseClass):
	...
	coclass_clsid = IID('{525A4B16-35CB-4D09-92EC-A267F0E487E5}')
...
class _FXGSaveOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{C3E5C6C3-1781-44FB-A5DB-DC8FCA4BB87B}')
...
class _GradientColor(DispatchBaseClass):
	...
	coclass_clsid = IID('{34A80F91-9BD1-4B28-B0F7-5B328344BE13}')
...
class _GrayColor(DispatchBaseClass):
	...
	coclass_clsid = IID('{7BDE49ED-2E43-4B6C-897D-53D1D8DD5780}')
...
class _GridRepeatConfig(DispatchBaseClass):
	...
	coclass_clsid = IID('{9401DC82-DE37-4E7A-B673-DE69F6C6754A}')
...
class _IllustratorSaveOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{4879FC74-7918-4460-AB9E-7E732FFB33C3}')
...
class _ImageCaptureOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{1563CB18-EE3B-4534-8441-7A7893D92E3A}')
...
class _Ink(DispatchBaseClass):
	...
	coclass_clsid = IID('{B717942D-F0B8-4CB4-955A-54A086AD9AE3}')
...
class _InkInfo(DispatchBaseClass):
	...
	coclass_clsid = IID('{2BBA3495-5244-46CE-8E84-CB0CC1B2374A}')
...
class _LabColor(DispatchBaseClass):
	...
	coclass_clsid = IID('{7E68869C-09F1-469C-8BC8-CB129FC79154}')
...
class _Matrix(DispatchBaseClass):
	...
	coclass_clsid = IID('{76172D0E-AEFD-4B3F-903E-EAF3D20E8BE7}')
...
class _NoColor(DispatchBaseClass):
	...
	coclass_clsid = IID('{BE3EF991-8616-48B5-95E0-E5425D89521A}')
...
class _OpenOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{53E516C2-88DA-4306-AE2F-94F82141A3A6}')
...
class _PDFSaveOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{E32FA349-64BE-4FC7-B8D3-D05AE797EFA2}')
...
class _PPDFile(DispatchBaseClass):
	...
	coclass_clsid = IID('{28A072A1-343B-4071-BEDC-C9A33F901D7D}')
...
class _PPDFileInfo(DispatchBaseClass):
	...
	coclass_clsid = IID('{A5DC83A1-159D-43D2-85B9-A7F842DCA33D}')
...
class _Paper(DispatchBaseClass):
	...
	coclass_clsid = IID('{45F97852-DAC7-4DAE-A3C1-1FC5CFAE7B91}')
...
class _PaperInfo(DispatchBaseClass):
	...
	coclass_clsid = IID('{59685A8C-0420-431A-94B2-3C703AB0CCCB}')
...
class _PatternColor(DispatchBaseClass):
	...
	coclass_clsid = IID('{379F392F-6204-4BA7-B0ED-2F29C5A47249}')
...
class _PrintColorManagementOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{738D4586-927F-40E9-9199-AC0E2A38AF52}')
...
class _PrintColorSeparationOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{D5FA1579-068F-4CE7-8A73-06DD760E5B75}')
...
class _PrintCoordinateOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{BE34C114-16A6-409E-9B36-EC98EE8FE1D6}')
...
class _PrintFlattenerOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{BD4A1F56-EA22-49AB-BA49-97C4097F0EC5}')
...
class _PrintFontOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{01381564-06F4-41F7-A1DE-CC47C2BCA59C}')
...
class _PrintJobOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{9EC38D7B-DE50-4D9F-93F0-2B7905990AB3}')
...
class _PrintOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{173E3D40-B777-4922-B9F8-EF4DB3C157F6}')
...
class _PrintPageMarksOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{90175CE6-BC0D-4AE1-96DC-37D5C5D03CEE}')
...
class _PrintPaperOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{1F74B3CA-DF29-4B69-9F95-B2935480D777}')
...
class _PrintPostScriptOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{5178E0B8-5BB2-4377-BF67-370AE1C1BC0E}')
...
class _Printer(DispatchBaseClass):
	...
	coclass_clsid = IID('{576F86EF-A90D-4A3B-A9F2-27971C690185}')
...
class _PrinterInfo(DispatchBaseClass):
	...
	coclass_clsid = IID('{FF694F01-24E9-4874-97C1-77108F71E7DB}')
...
class _RGBColor(DispatchBaseClass):
	...
	coclass_clsid = IID('{A6BDC2E0-63C7-4324-9F02-51AE4DB823D6}')
...
class _RadialRepeatConfig(DispatchBaseClass):
	...
	coclass_clsid = IID('{8142512C-A919-4B36-95DB-69C70AFCF414}')
...
class _RasterEffectOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{06F22A18-E2DB-4E18-920F-3640A313C5E9}')
...
class _RasterizeOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{9DE071CE-5D95-4780-844A-2F481D18AE10}')
...
class _Screen(DispatchBaseClass):
	...
	coclass_clsid = IID('{1C870BA1-9416-49DA-8295-205A50C3C0D1}')
...
class _ScreenInfo(DispatchBaseClass):
	...
	coclass_clsid = IID('{9D0E34B1-BAFB-4D3B-B151-3D773ED3E5C9}')
...
class _ScreenSpotFunction(DispatchBaseClass):
	...
	coclass_clsid = IID('{C16A80DC-321B-48C8-8999-F3FEB3505B53}')
...
class _SpotColor(DispatchBaseClass):
	...
	coclass_clsid = IID('{34834A61-6D98-431D-B296-F09C3093CD6F}')
...
class _SymmetryRepeatConfig(DispatchBaseClass):
	...
	coclass_clsid = IID('{FBAD26BA-9BA4-45B1-83F5-665F87CBEC5A}')
...
class _TabStopInfo(DispatchBaseClass):
	...
	coclass_clsid = IID('{7E461A8C-5364-4955-8305-CFAB26BC62CE}')
...
# This CoClass is known by the name 'Illustrator.Application.25'
class Application(CoClassBaseClass): # A CoClass
	# The Adobe Illustrator application
	CLSID = IID('{7CACE1D4-C629-4A43-8E45-800FB2B00015}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_Application,
...
# This CoClass is known by the name 'Illustrator.CMYKColor.25'
class CMYKColor(CoClassBaseClass): # A CoClass
	# A CMYK color specification
	CLSID = IID('{B3ED0A49-88C1-4404-904B-707BA58F4DB8}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_CMYKColor,
...
class Dimensions(CoClassBaseClass): # A CoClass
	# Dimensions (height and width)
	CLSID = IID('{BAED5626-5928-432A-BDB1-8712C1FFD1AA}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_Dimensions,
...
# This CoClass is known by the name 'Illustrator.DocumentPreset.25'
class DocumentPreset(CoClassBaseClass): # A CoClass
	# the new document preset to use for creating a new document
	CLSID = IID('{48F2D380-582A-44FF-BDA3-1F5C10749F1A}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_DocumentPreset,
...
# This CoClass is known by the name 'Illustrator.EPSSaveOptions.25'
class EPSSaveOptions(CoClassBaseClass): # A CoClass
	# Options which may be supplied when saving a document as an Illustrator EPS file
	CLSID = IID('{A58534E1-AE76-4F4E-89F6-D7FF62505CED}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_EPSSaveOptions,
...
# This CoClass is known by the name 'Illustrator.ExportForScreensItemToExport.25'
class ExportForScreensItemToExport(CoClassBaseClass): # A CoClass
	# An item that needs to be exported; for example, a document, artboard, or asset
	CLSID = IID('{4598B50D-CF01-4F98-9221-B85BA0AE7887}')
	coclass_sources = [
	]
	coclass_interfaces = [
...
# This CoClass is known by the name 'Illustrator.ExportForScreensOptionsJPEG.25'
class ExportForScreensOptionsJPEG(CoClassBaseClass): # A CoClass
	# Options which may be provided when exporting a document as a JPEG100 file
	CLSID = IID('{61961433-502B-4D9B-B01F-4F9104743D61}')
	coclass_sources = [
	]
	coclass_interfaces = [
...
# This CoClass is known by the name 'Illustrator.ExportForScreensOptionsPNG24.25'
class ExportForScreensOptionsPNG24(CoClassBaseClass): # A CoClass
	# Options which may be provided when exporting a document as an 24 bit PNG file
	CLSID = IID('{7FE48456-9E59-4A68-A574-22C94B55B63D}')
	coclass_sources = [
	]
	coclass_interfaces = [
...
# This CoClass is known by the name 'Illustrator.ExportForScreensOptionsPNG8.25'
class ExportForScreensOptionsPNG8(CoClassBaseClass): # A CoClass
	# Options which may be provided when exporting a document as an 8 bit PNG file
	CLSID = IID('{5E018E7D-FFB0-419B-921C-8C3C7B1D2266}')
	coclass_sources = [
	]
	coclass_interfaces = [
...
# This CoClass is known by the name 'Illustrator.ExportForScreensOptionsWebOptimizedSVG.25'
class ExportForScreensOptionsWebOptimizedSVG(CoClassBaseClass): # A CoClass
	# Options which may be provided when exporting a document as a web optimized SVG file
	CLSID = IID('{B6381ED3-F3A1-4172-8E92-37C4B89B3A91}')
	coclass_sources = [
	]
	coclass_interfaces = [
...
# This CoClass is known by the name 'Illustrator.ExportForScreensPDFOptions.25'
class ExportForScreensPDFOptions(CoClassBaseClass): # A CoClass
	# Options which may be provided when exporting a document as a PDF file.
	CLSID = IID('{6B43D877-331F-417D-BED7-4DFC63BC8731}')
	coclass_sources = [
	]
	coclass_interfaces = [
...
# This CoClass is known by the name 'Illustrator.ExportOptionsAutoCAD.25'
class ExportOptionsAutoCAD(CoClassBaseClass): # A CoClass
	# Options which may be supplied when exporting a document to AutoCAD formats (.dwg or .dxf)
	CLSID = IID('{6E8DB625-6B40-4F7F-BD15-CD11A533FEB9}')
	coclass_sources = [
	]
	coclass_interfaces = [
...
# This CoClass is known by the name 'Illustrator.ExportOptionsFlash.25'
class ExportOptionsFlash(CoClassBaseClass): # A CoClass
	# Options which may be supplied when exporting a document as an Flash (.SWF) file
	CLSID = IID('{B93B4F70-262D-4E9E-BD7B-EF181865B55A}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_ExportOptionsFlash,
...
# This CoClass is known by the name 'Illustrator.ExportOptionsGIF.25'
class ExportOptionsGIF(CoClassBaseClass): # A CoClass
	# Options which may be supplied when exporting a document as a GIF file
	CLSID = IID('{E831E5A3-6F71-461A-95C1-50812357F50C}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_ExportOptionsGIF,
...
# This CoClass is known by the name 'Illustrator.ExportOptionsJPEG.25'
class ExportOptionsJPEG(CoClassBaseClass): # A CoClass
	# Options which may be supplied when exporting a document as a JPEG file
	CLSID = IID('{7D014CE6-4934-4A50-914A-7729247C44DF}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_ExportOptionsJPEG,
...
# This CoClass is known by the name 'Illustrator.ExportOptionsPNG24.25'
class ExportOptionsPNG24(CoClassBaseClass): # A CoClass
	# Options which may be supplied when exporting a document as an 24 bit PNG file
	CLSID = IID('{7BB47D53-1D11-49D1-9D16-0A13715404ED}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_ExportOptionsPNG24,
...
# This CoClass is known by the name 'Illustrator.ExportOptionsPNG8.25'
class ExportOptionsPNG8(CoClassBaseClass): # A CoClass
	# Options which may be supplied when exporting a document as an 8 bit PNG file
	CLSID = IID('{3F0A136F-C0DA-4DC5-8AFA-A0A89F72817F}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_ExportOptionsPNG8,
...
# This CoClass is known by the name 'Illustrator.ExportOptionsPhotoshop.25'
class ExportOptionsPhotoshop(CoClassBaseClass): # A CoClass
	# Options which may be supplied when exporting a document as a Photoshop file
	CLSID = IID('{1F6ACC71-4D6C-4DDC-9318-E25D086DF7C1}')
	coclass_sources = [
	]
	coclass_interfaces = [
...
# This CoClass is known by the name 'Illustrator.ExportOptionsSVG.25'
class ExportOptionsSVG(CoClassBaseClass): # A CoClass
	# Options which may be supplied when exporting a document as an SVG file
	CLSID = IID('{DE11E0DD-668F-4888-8953-B6D7E37C022F}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_ExportOptionsSVG,
...
# This CoClass is known by the name 'Illustrator.ExportOptionsTIFF.25'
class ExportOptionsTIFF(CoClassBaseClass): # A CoClass
	# Options which may be supplied when exporting a document as a TIFF file
	CLSID = IID('{7710CBD8-E89B-429D-8F5C-E2A9B5872311}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_ExportOptionsTIFF,
...
# This CoClass is known by the name 'Illustrator.ExportOptionsWebOptimizedSVG.25'
class ExportOptionsWebOptimizedSVG(CoClassBaseClass): # A CoClass
	# Options which may be supplied when exporting a document as a Web optimized SVG file
	CLSID = IID('{525A4B16-35CB-4D09-92EC-A267F0E487E5}')
	coclass_sources = [
	]
	coclass_interfaces = [
...
# This CoClass is known by the name 'Illustrator.FXGSaveOptions.25'
class FXGSaveOptions(CoClassBaseClass): # A CoClass
	# Options which may be supplied when saving a document as an FXG file
	CLSID = IID('{C3E5C6C3-1781-44FB-A5DB-DC8FCA4BB87B}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_FXGSaveOptions,
...
# This CoClass is known by the name 'Illustrator.GradientColor.25'
class GradientColor(CoClassBaseClass): # A CoClass
	# A Gradient color specification
	CLSID = IID('{34A80F91-9BD1-4B28-B0F7-5B328344BE13}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_GradientColor,
...
class GrayColor(CoClassBaseClass): # A CoClass
	# A gray color specification
	CLSID = IID('{7BDE49ED-2E43-4B6C-897D-53D1D8DD5780}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_GrayColor,
...
class GridRepeatConfig(CoClassBaseClass): # A CoClass
	# options for grid repaat art configuration
	CLSID = IID('{9401DC82-DE37-4E7A-B673-DE69F6C6754A}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_GridRepeatConfig,
...
# This CoClass is known by the name 'Illustrator.IllustratorSaveOptions.25'
class IllustratorSaveOptions(CoClassBaseClass): # A CoClass
	# Options which may be supplied when saving a document as an Illustrator file
	CLSID = IID('{4879FC74-7918-4460-AB9E-7E732FFB33C3}')
	coclass_sources = [
	]
	coclass_interfaces = [
...
# This CoClass is known by the name 'Illustrator.ImageCaptureOptions.25'
class ImageCaptureOptions(CoClassBaseClass): # A CoClass
	# Options which may be supplied when capturing a portion of the artwork as an 24 bit PNG file
	CLSID = IID('{1563CB18-EE3B-4534-8441-7A7893D92E3A}')
	coclass_sources = [
	]
	coclass_interfaces = [
...
# This CoClass is known by the name 'Illustrator.Ink.25'
class Ink(CoClassBaseClass): # A CoClass
	# printer's ink
	CLSID = IID('{B717942D-F0B8-4CB4-955A-54A086AD9AE3}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_Ink,
...
# This CoClass is known by the name 'Illustrator.InkInfo.25'
class InkInfo(CoClassBaseClass): # A CoClass
	# Ink information
	CLSID = IID('{2BBA3495-5244-46CE-8E84-CB0CC1B2374A}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_InkInfo,
...
# This CoClass is known by the name 'Illustrator.LabColor.25'
class LabColor(CoClassBaseClass): # A CoClass
	# An Lab color specification
	CLSID = IID('{7E68869C-09F1-469C-8BC8-CB129FC79154}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_LabColor,
...
# This CoClass is known by the name 'Illustrator.Matrix.25'
class Matrix(CoClassBaseClass): # A CoClass
	CLSID = IID('{76172D0E-AEFD-4B3F-903E-EAF3D20E8BE7}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_Matrix,
...
# This CoClass is known by the name 'Illustrator.NoColor.25'
class NoColor(CoClassBaseClass): # A CoClass
	# represents the 'none' color
	CLSID = IID('{BE3EF991-8616-48B5-95E0-E5425D89521A}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_NoColor,
...
# This CoClass is known by the name 'Illustrator.OpenOptions.25'
class OpenOptions(CoClassBaseClass): # A CoClass
	# Options which may be supplied when opening a file
	CLSID = IID('{53E516C2-88DA-4306-AE2F-94F82141A3A6}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_OpenOptions,
...
# This CoClass is known by the name 'Illustrator.PDFSaveOptions.25'
class PDFSaveOptions(CoClassBaseClass): # A CoClass
	# Options which may be supplied when saving a document as a PDF file
	CLSID = IID('{E32FA349-64BE-4FC7-B8D3-D05AE797EFA2}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_PDFSaveOptions,
...
# This CoClass is known by the name 'Illustrator.PPDFile.25'
class PPDFile(CoClassBaseClass): # A CoClass
	# a PPD file
	CLSID = IID('{28A072A1-343B-4071-BEDC-C9A33F901D7D}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_PPDFile,
...
# This CoClass is known by the name 'Illustrator.PPDFileInfo.25'
class PPDFileInfo(CoClassBaseClass): # A CoClass
	# PPD file information
	CLSID = IID('{A5DC83A1-159D-43D2-85B9-A7F842DCA33D}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_PPDFileInfo,
...
# This CoClass is known by the name 'Illustrator.Paper.25'
class Paper(CoClassBaseClass): # A CoClass
	# paper size
	CLSID = IID('{45F97852-DAC7-4DAE-A3C1-1FC5CFAE7B91}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_Paper,
...
# This CoClass is known by the name 'Illustrator.PaperInfo.25'
class PaperInfo(CoClassBaseClass): # A CoClass
	# Paper information
	CLSID = IID('{59685A8C-0420-431A-94B2-3C703AB0CCCB}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_PaperInfo,
...
# This CoClass is known by the name 'Illustrator.PatternColor.25'
class PatternColor(CoClassBaseClass): # A CoClass
	# A Pattern color specification
	CLSID = IID('{379F392F-6204-4BA7-B0ED-2F29C5A47249}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_PatternColor,
...
# This CoClass is known by the name 'Illustrator.PrintColorManagementOptions.25'
class PrintColorManagementOptions(CoClassBaseClass): # A CoClass
	# the color management options
	CLSID = IID('{738D4586-927F-40E9-9199-AC0E2A38AF52}')
	coclass_sources = [
	]
	coclass_interfaces = [
...
# This CoClass is known by the name 'Illustrator.PrintColorSeparationOptions.25'
class PrintColorSeparationOptions(CoClassBaseClass): # A CoClass
	# Print color separation options
	CLSID = IID('{D5FA1579-068F-4CE7-8A73-06DD760E5B75}')
	coclass_sources = [
	]
	coclass_interfaces = [
...
class PrintCoordinateOptions(CoClassBaseClass): # A CoClass
	# the print coordinate options
	CLSID = IID('{BE34C114-16A6-409E-9B36-EC98EE8FE1D6}')
	coclass_sources = [
	]
	coclass_interfaces = [
...
# This CoClass is known by the name 'Illustrator.PrintFlattenerOptions.25'
class PrintFlattenerOptions(CoClassBaseClass): # A CoClass
	# the transparency flattening options
	CLSID = IID('{BD4A1F56-EA22-49AB-BA49-97C4097F0EC5}')
	coclass_sources = [
	]
	coclass_interfaces = [
...
# This CoClass is known by the name 'Illustrator.PrintFontOptions.25'
class PrintFontOptions(CoClassBaseClass): # A CoClass
	# the font options for printing
	CLSID = IID('{01381564-06F4-41F7-A1DE-CC47C2BCA59C}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_PrintFontOptions,
...
# This CoClass is known by the name 'Illustrator.PrintJobOptions.25'
class PrintJobOptions(CoClassBaseClass): # A CoClass
	# the print job options
	CLSID = IID('{9EC38D7B-DE50-4D9F-93F0-2B7905990AB3}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_PrintJobOptions,
...
# This CoClass is known by the name 'Illustrator.PrintOptions.25'
class PrintOptions(CoClassBaseClass): # A CoClass
	# the print options
	CLSID = IID('{173E3D40-B777-4922-B9F8-EF4DB3C157F6}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_PrintOptions,
...
# This CoClass is known by the name 'Illustrator.PrintPageMarksOptions.25'
class PrintPageMarksOptions(CoClassBaseClass): # A CoClass
	# the page marks options
	CLSID = IID('{90175CE6-BC0D-4AE1-96DC-37D5C5D03CEE}')
	coclass_sources = [
	]
	coclass_interfaces = [
...
# This CoClass is known by the name 'Illustrator.PrintPaperOptions.25'
class PrintPaperOptions(CoClassBaseClass): # A CoClass
	# the paper options
	CLSID = IID('{1F74B3CA-DF29-4B69-9F95-B2935480D777}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_PrintPaperOptions,
...
# This CoClass is known by the name 'Illustrator.PrintPostScriptOptions.25'
class PrintPostScriptOptions(CoClassBaseClass): # A CoClass
	# the PostScript options
	CLSID = IID('{5178E0B8-5BB2-4377-BF67-370AE1C1BC0E}')
	coclass_sources = [
	]
	coclass_interfaces = [
...
# This CoClass is known by the name 'Illustrator.Printer.25'
class Printer(CoClassBaseClass): # A CoClass
	# an installed printer
	CLSID = IID('{576F86EF-A90D-4A3B-A9F2-27971C690185}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_Printer,
...
# This CoClass is known by the name 'Illustrator.PrinterInfo.25'
class PrinterInfo(CoClassBaseClass): # A CoClass
	# printer information
	CLSID = IID('{FF694F01-24E9-4874-97C1-77108F71E7DB}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_PrinterInfo,
...
# This CoClass is known by the name 'Illustrator.RGBColor.25'
class RGBColor(CoClassBaseClass): # A CoClass
	# An RGB color specification
	CLSID = IID('{A6BDC2E0-63C7-4324-9F02-51AE4DB823D6}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_RGBColor,
...
class RadialRepeatConfig(CoClassBaseClass): # A CoClass
	# options for radial repaat art configuration
	CLSID = IID('{8142512C-A919-4B36-95DB-69C70AFCF414}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_RadialRepeatConfig,
...
# This CoClass is known by the name 'Illustrator.RasterEffectOptions.25'
class RasterEffectOptions(CoClassBaseClass): # A CoClass
	# The document raster effects settings
	CLSID = IID('{06F22A18-E2DB-4E18-920F-3640A313C5E9}')
	coclass_sources = [
	]
	coclass_interfaces = [
...
# This CoClass is known by the name 'Illustrator.RasterizeOptions.25'
class RasterizeOptions(CoClassBaseClass): # A CoClass
	# Options which may be supplied when rasterizing the artwork
	CLSID = IID('{9DE071CE-5D95-4780-844A-2F481D18AE10}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_RasterizeOptions,
...
# This CoClass is known by the name 'Illustrator.Screen.25'
class Screen(CoClassBaseClass): # A CoClass
	# color separation screen
	CLSID = IID('{1C870BA1-9416-49DA-8295-205A50C3C0D1}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_Screen,
...
# This CoClass is known by the name 'Illustrator.ScreenInfo.25'
class ScreenInfo(CoClassBaseClass): # A CoClass
	# Screen information
	CLSID = IID('{9D0E34B1-BAFB-4D3B-B151-3D773ED3E5C9}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_ScreenInfo,
...
# This CoClass is known by the name 'Illustrator.ScreenSpotFunction.25'
class ScreenSpotFunction(CoClassBaseClass): # A CoClass
	# color separation screen spot function
	CLSID = IID('{C16A80DC-321B-48C8-8999-F3FEB3505B53}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_ScreenSpotFunction,
...
# This CoClass is known by the name 'Illustrator.SpotColor.25'
class SpotColor(CoClassBaseClass): # A CoClass
	# Information about the spot color
	CLSID = IID('{34834A61-6D98-431D-B296-F09C3093CD6F}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_SpotColor,
...
class SymmetryRepeatConfig(CoClassBaseClass): # A CoClass
	# options for symmetry repaat art configuration
	CLSID = IID('{FBAD26BA-9BA4-45B1-83F5-665F87CBEC5A}')
	coclass_sources = [
	]
	coclass_interfaces = [
...
# This CoClass is known by the name 'Illustrator.TabStopInfo.25'
class TabStopInfo(CoClassBaseClass): # A CoClass
	# Tab stop information (returned by tab stops from a paragraph object)
	CLSID = IID('{7E461A8C-5364-4955-8305-CFAB26BC62CE}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_TabStopInfo,
...
CLSIDToClassMap = {
	...
	'{9DE071CE-5D95-4780-844A-2F481D18AE10}' : RasterizeOptions,
	'{D5FA1579-068F-4CE7-8A73-06DD760E5B75}' : PrintColorSeparationOptions,
	'{5178E0B8-5BB2-4377-BF67-370AE1C1BC0E}' : PrintPostScriptOptions,
	'{7FE48456-9E59-4A68-A574-22C94B55B63D}' : ExportForScreensOptionsPNG24,
	'{AD865867-DED8-42D6-9BD8-D77533905975}' : AutoCADFileOptions,
	'{95CD20E7-AD72-11D3-B086-0010A4F5C335}' : Patterns,
	'{61961433-502B-4D9B-B01F-4F9104743D61}' : ExportForScreensOptionsJPEG,
	'{A07B43A9-0201-4369-A1B5-8A33C8A0BB23}' : _ExportOptionsPhotoshop,
	'{95CD20E8-AD72-11D3-B086-0010A4F5C335}' : Brushes,
	'{76172D0E-AEFD-4B3F-903E-EAF3D20E8BE7}' : Matrix,
	...
	'{2BBA3495-5244-46CE-8E84-CB0CC1B2374A}' : InkInfo,
	'{8507C961-DE07-440E-A2D8-6D48247ABF79}' : Story,
	'{4C78DFCC-7A09-11D4-81A0-00C04F60ECCC}' : Preferences,
	'{5E018E7D-FFB0-419B-921C-8C3C7B1D2266}' : ExportForScreensOptionsPNG8,
	'{BD4A1F56-EA22-49AB-BA49-97C4097F0EC5}' : PrintFlattenerOptions,
	'{7CACE1D4-C629-4A43-8E45-800FB2B00015}' : Application,
	'{B3ED0A49-88C1-4404-904B-707BA58F4DB8}' : CMYKColor,
	'{4598B50D-CF01-4F98-9221-B85BA0AE7887}' : ExportForScreensItemToExport,
	'{A58534E1-AE76-4F4E-89F6-D7FF62505CED}' : EPSSaveOptions,
	'{BE34C114-16A6-409E-9B36-EC98EE8FE1D6}' : PrintCoordinateOptions,
	'{95CD20F0-AD72-11D3-B086-0010A4F5C335}' : Views,
	'{AD25A97A-80BC-4D6A-9E61-7E288DE977CA}' : _ExportOptionsAutoCAD,
	'{7E68869C-09F1-469C-8BC8-CB129FC79154}' : LabColor,
	'{90175CE6-BC0D-4AE1-96DC-37D5C5D03CEE}' : PrintPageMarksOptions,
	...
	'{525A4B16-35CB-4D09-92EC-A267F0E487E5}' : ExportOptionsWebOptimizedSVG,
	'{95CD20B2-AD72-11D3-B086-0010A4F5C335}' : _CMYKColor,
	'{1563CB18-EE3B-4534-8441-7A7893D92E3A}' : ImageCaptureOptions,
	'{53E516C2-88DA-4306-AE2F-94F82141A3A6}' : OpenOptions,
	...
	'{7710CBD8-E89B-429D-8F5C-E2A9B5872311}' : ExportOptionsTIFF,
	'{B6381ED3-F3A1-4172-8E92-37C4B89B3A91}' : ExportForScreensOptionsWebOptimizedSVG,
	...
	'{7BB47D53-1D11-49D1-9D16-0A13715404ED}' : ExportOptionsPNG24,
	'{4C78DFEB-7A09-11D4-81A0-00C04F60ECCC}' : _ImageCaptureOptions,
	'{6E8DB625-6B40-4F7F-BD15-CD11A533FEB9}' : ExportOptionsAutoCAD,
	'{4C78DFC0-7A09-11D4-81A0-00C04F60ECCC}' : Symbol,
	'{E831E5A3-6F71-461A-95C1-50812357F50C}' : ExportOptionsGIF,
	'{BAED5626-5928-432A-BDB1-8712C1FFD1AA}' : Dimensions,
	...
	'{173E3D40-B777-4922-B9F8-EF4DB3C157F6}' : PrintOptions,
	...
	'{1F74B3CA-DF29-4B69-9F95-B2935480D777}' : PrintPaperOptions,
	'{30557E1D-A243-499D-84B8-6E170B36A1BD}' : Artboard,
	'{FF327E57-2EDA-4934-B3FD-CF470C62989D}' : EmbeddedItems,
	'{06F22A18-E2DB-4E18-920F-3640A313C5E9}' : RasterEffectOptions,
	...
	'{B717942D-F0B8-4CB4-955A-54A086AD9AE3}' : Ink,
	'{A5DC83A1-159D-43D2-85B9-A7F842DCA33D}' : PPDFileInfo,
	'{9157F2B0-D436-4AC6-9769-94DC89E6EC92}' : NonNativeItems,
	'{4C78DFA8-7A09-11D4-81A0-00C04F60ECCC}' : Variables,
	'{FF694F01-24E9-4874-97C1-77108F71E7DB}' : PrinterInfo,
	'{DE11E0DD-668F-4888-8953-B6D7E37C022F}' : ExportOptionsSVG,
	...
	'{34834A61-6D98-431D-B296-F09C3093CD6F}' : SpotColor,
	'{2A8F3C5F-B4E3-45BB-89CB-93F062B4F9F1}' : _ExportOptionsTIFF,
	'{7D014CE6-4934-4A50-914A-7729247C44DF}' : ExportOptionsJPEG,
	'{0FABF3E6-D6AF-4ADB-BB5E-7DEFE0E194B2}' : GridRepeatItems,
	'{DB10BDB0-CC74-49DC-B9C6-8069AF4765BB}' : _ExportForScreensPDFOptions,
	'{C16A80DC-321B-48C8-8999-F3FEB3505B53}' : ScreenSpotFunction,
	'{1C870BA1-9416-49DA-8295-205A50C3C0D1}' : Screen,
	...
	'{8142512C-A919-4B36-95DB-69C70AFCF414}' : RadialRepeatConfig,
	...
	'{9EC38D7B-DE50-4D9F-93F0-2B7905990AB3}' : PrintJobOptions,
	'{9401DC82-DE37-4E7A-B673-DE69F6C6754A}' : GridRepeatConfig,
	'{4879FC74-7918-4460-AB9E-7E732FFB33C3}' : IllustratorSaveOptions,
	'{60E764BB-CBEE-421F-B706-D228072EBB89}' : _OpenOptions,
	'{FBAD26BA-9BA4-45B1-83F5-665F87CBEC5A}' : SymmetryRepeatConfig,
	'{558EF46F-A352-4A0D-9B1C-A2F6118FE611}' : SwatchGroups,
	'{7E461A8C-5364-4955-8305-CFAB26BC62CE}' : TabStopInfo,
	'{3F0A136F-C0DA-4DC5-8AFA-A0A89F72817F}' : ExportOptionsPNG8,
	'{95CD20CD-AD72-11D3-B086-0010A4F5C335}' : _ExportOptionsGIF,
	'{48F2D380-582A-44FF-BDA3-1F5C10749F1A}' : DocumentPreset,
	'{1F6ACC71-4D6C-4DDC-9318-E25D086DF7C1}' : ExportOptionsPhotoshop,
	'{59685A8C-0420-431A-94B2-3C703AB0CCCB}' : PaperInfo,
	'{0E9E7B8C-BF29-4A10-9B1C-9F292FDAB07A}' : Stories,
	'{4C78DFBD-7A09-11D4-81A0-00C04F60ECCC}' : PDFFileOptions,
	'{45F97852-DAC7-4DAE-A3C1-1FC5CFAE7B91}' : Paper,
	'{F0692236-A49A-474D-9745-715426856760}' : TextFrame,
	'{7C1FA60D-BF8F-4C43-B14C-77D842034966}' : CharacterStyle,
	'{7BDE49ED-2E43-4B6C-897D-53D1D8DD5780}' : GrayColor,
	'{A6BDC2E0-63C7-4324-9F02-51AE4DB823D6}' : RGBColor,
	'{34A80F91-9BD1-4B28-B0F7-5B328344BE13}' : GradientColor,
	...
	'{BE3EF991-8616-48B5-95E0-E5425D89521A}' : NoColor,
	'{9D0E34B1-BAFB-4D3B-B151-3D773ED3E5C9}' : ScreenInfo,
	'{E32FA349-64BE-4FC7-B8D3-D05AE797EFA2}' : PDFSaveOptions,
	'{379F392F-6204-4BA7-B0ED-2F29C5A47249}' : PatternColor,
	'{95CD20D6-AD72-11D3-B086-0010A4F5C335}' : Words,
	'{01381564-06F4-41F7-A1DE-CC47C2BCA59C}' : PrintFontOptions,
	'{C3E5C6C3-1781-44FB-A5DB-DC8FCA4BB87B}' : FXGSaveOptions,
	'{2A144F2D-BD94-4175-B192-1F8143026200}' : Asset,
	'{6B43D877-331F-417D-BED7-4DFC63BC8731}' : ExportForScreensPDFOptions,
	'{95CD20D9-AD72-11D3-B086-0010A4F5C335}' : Spots,
	'{091ADAF8-D422-11DB-8314-0800200C9A66}' : Artboards,
	'{738D4586-927F-40E9-9199-AC0E2A38AF52}' : PrintColorManagementOptions,
	'{576F86EF-A90D-4A3B-A9F2-27971C690185}' : Printer,
	...
	'{28A072A1-343B-4071-BEDC-C9A33F901D7D}' : PPDFile,
	...
	'{B93B4F70-262D-4E9E-BD7B-EF181865B55A}' : ExportOptionsFlash,
}
CLSIDToPackageMap = {}
